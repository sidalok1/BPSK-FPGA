...
#
# Script generated by Vivado on Wed Nov 12 15:01:06 -0800 2025
...
#
# Usage        : clk_gen.sh
#                clk_gen.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                clk_gen.sh [-reset_run]
#                clk_gen.sh [-reset_log]
#                clk_gen.sh [-help]
#
...
#                script (type 'clk_gen.sh -help' for more information).
#
...
# script info
echo -e "clk_gen.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./clk_gen.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.clk_gen xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.clk_gen -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log clk_gen_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: clk_gen.sh [-step]\n\
Usage: clk_gen.sh [-lib_map_path]\n\
Usage: clk_gen.sh [-reset_run]\n\
Usage: clk_gen.sh [-reset_log]\n\
Usage: clk_gen.sh [-keep_index]\n\
